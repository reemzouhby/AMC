...
if __name__ == "__main__":
    ...
    model_name = "GoogLeNet2D Spectrogram"
    ...
    model.fc = nn.Sequential(
        ...
        nn.BatchNorm1d(256),
        nn.ReLU(),
        nn.Dropout(p=0.5),          # higher dropout for spectrogram (more domain gap)
        nn.Linear(256, 128),
        nn.BatchNorm1d(128),
        nn.ReLU(),
        nn.Dropout(p=0.4),
    ...
    # ── 5. Optimizer ──────────────────────────────────────────────────────────
    # Higher weight decay for spectrogram to fight overfitting
    ...
    ], weight_decay=3e-3)              # stronger than constellation (1e-3)
    ...
    SAVE_PATH = "googlenet2d_spectrogram_best.pth"
    ...
    plt.tight_layout()
    plt.savefig("googlenet2d_spectrogram_training_curves.png", dpi=150)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("googlenet2d_spectrogram_snr_accuracy.png", dpi=150)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig("googlenet2d_spectrogram_confusion_matrix.png", dpi=150)
    plt.show()
